...
const Sidebar = () => {
  ...
  return (
    <div className='flex'>
    <div className={`${open ? 'w-[250px]' : 'w-[85px] overflow-hidden' } bg-blue-900 sidebar fixed top-0 bottom-0 lg:left-0 p-2 overflow-y-hidden overflow-x-hidden text-center border-0 border-radius-xl ease-in-out duration-300`}>
