...
const ViewLeaveApplication = ({ visible, onClick, edit, ID }) => {
  ...
  useEffect(() => {
    if (Employees) {
      // Perform filtering only if Employees is not null or undefined
      const filteredList = Employees.filter((employee) => {
        // Check if EmployeeName exists and matches the searchTerm (case-insensitive)
        return (
        ...
        <div className="bg-gray-200 w-[60%]  p-8 rounded-lg max-h-[90%]">
          ...
          <div className="py-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="py-0">
                <p className="font-semibold text-[13px]">Employee Type Group</p>
                <select
                  disabled={!edit}
              ...
              <div className="">
                ...
                >
                  <option value={formik.values.EmployeeType}>
