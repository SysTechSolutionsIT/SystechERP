...
const UserRights = ({ ID }) => {
  ...
  const fetchAccessRights = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5500/users/allowed-access",
        {
  ...
  useEffect(() => {
    ...
    const threeDigitLabels = allLabels.filter(
      (label) => label >= 100 && label <= 999
    );
        ...
        <div className="mt-2 ml-2">
          <div className="flex items-center">
            <Icon
              ...
              className="cursor-pointer hover:shadow-lg duration-300 mr-2"
              width="24"
              height="24"
              style={{ color: "#1ec247" }}
            ...
            <Icon
              ...
              className="cursor-pointer hover:shadow-lg duration-300 ml-2"
              width="22"
              height="22"
              style={{ color: "#e63333" }}
  ...
  const Menu8 = [
    {
      title: "Register",
      items: [{ name: "593", label: "Master Register" }],
    },
  ];
