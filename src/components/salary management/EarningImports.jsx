...
import EarningImportModal from './EarningImportModal';

const EarningImports = () => {
    ...
    const fetchHeadsData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5500/monthly-earning-import/FnShowActiveData",
          {
            headers: {
                            ...
                            <div className="flex gap-2 text-center">
                              <Icon
                                ...
                                onClick={() => {
                                  ...
                                  setEHid(result.MonthlyEarningId); // Pass ID to VEModal
                                }}
                              />
                              <Icon
                                icon="mdi:edit"
