    ...
    const fetchKRA = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5500/KRA-master/FnShowActiveData",
          {
            headers: {
  ...
  const deleteKRA = async (DeleteId) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5500/KRA-master/FnAddUpdateDeleteRecord`,
        {
          KRAId: DeleteId,
          IUFlag: "D",
        },
        ...
        <div className="my-1 rounded-2xl bg-white p-2 pr-8">
          <table className="min-w-full text-center rounded-lg  whitespace-normal">
            ...
            <tbody>
                      ...
                      <div className="flex items-center gap-2 text-center justify-center">
                        <Icon
                          ...
                          onClick={() => {
                            ...
                            setid(entry.KRAId); // Pass ID to VEModal
                          }}
                        />
                        <Icon
                          className="cursor-pointer"
              ...
              ) : filteredData.length === 0 && KRAData && KRAData.length > 0 ? (
