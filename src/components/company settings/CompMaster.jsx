  ...
  return (
    <div className="top-25 min-w-[40%]">
      <div className="bg-blue-900 h-15 p-2 ml-2 px-8 text-white font-semibold text-lg rounded-lg flex items-center justify-between mb-1 sm:overflow-x-clip">
        <div className="text-[15px]">Company Settings / Company Master</div>
      ...
      <td className="px-2 border-2">
        <div className="flex items-center gap-2 text-center justify-center">
          ...
          <Icon
            ...
            height="20"
            className="cursor-pointer"
            onClick={() => deleteComp(result.CompanyId)}
          />
        </div>
      </td>
...
) : filteredData.length === 0 && companies && companies.length > 0 ? (
