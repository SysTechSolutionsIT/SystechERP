...
const DepartmentModal = ({visible, onClick}) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
        ...
        <div>
            <p className='capatilize font-semibold'>Parent Department Name</p>
            <select
                id="parentDept"
            ...
            <option value="Times Keeping Department">Times Keeping Department</option>
            ...
            <option value="Designing Department">Designing Department</option>
            </select>
        </div>
        <div>
        ...
        <div>
            <p className='capatilize font-semibold'>Standard Staff Strength</p>
            <input
        ...
        <div>
            <p className='capatilize font-semibold'>Standard Worker Strength</p>
            <input
