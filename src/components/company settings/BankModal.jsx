...
const BankModal = ({visible, onClick}) =>{
    ...
    return (
        ...
        <div>
            ...
            <option value="Foriegn currency non-resident (FCNR) account">Foriegn currency non-resident (FCNR) account</option>
        ...
        <div>
            <p className='capatilize font-semibold'>Registered Contact No.</p>
            <input
        ...
        <div>
            <p className='capatilize font-semibold'>Authorized Person Count</p>
            <input
                id="authPersonCount"
                type="number"
